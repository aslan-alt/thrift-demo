...
class InvalidaOperation(TException):
    """
    Attributes:
     - whatOp
     - why
    ...
    def __init__(self, whatOp=None, why=None,):
        super(InvalidaOperation, self).__setattr__('whatOp', whatOp)
        super(InvalidaOperation, self).__setattr__('why', why)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('InvalidaOperation')
...
class Work(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(InvalidaOperation)
InvalidaOperation.thrift_spec = (
    None,  # 0
